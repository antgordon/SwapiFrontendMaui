...
namespace MauiApp1.Services
{
    public interface ISwapiApiService
    {
        ...
        public Task<VehiclesSearchModel?> SearchVehicles(string query, int page = 1);

        public Task<VehicleModel?> GetVehicle(string id);

        public Task<PeopleSearchModel?> SearchPeople(string query, int page = 1);

        public Task<PeopleModel?> GetPeople(string id);

        public Task<StarshipsSearchModel> SearchStarships(string query, int page = 1);
